...
Feature: Check sections in OPS UI pages
  ...
  Scenario: Check sections in inquiry details page in OPS UI for a newly created inquiry
    ...
    And admin sees "AXA" page section
    And admin sees that 3 row of "AXA" section contains "Details"
    And admin sees that 4 row of "AXA" section contains "Average response time nicht angegeben"
    And admin sees that 7 row of "AXA" section contains "Kontaktdaten"
    And admin sees that 8 row of "AXA" section contains "Info phone +43131670980"
  ...
  Scenario: Check sections in opportunity details page in OPS UI for a newly created opportunity
    ...
    And user selects "Private Altersvorsorge & Vermögensaufbau" category option
    ...
    When user enters "50000" into answer input field
    And  user clicks on "Weiter" button
