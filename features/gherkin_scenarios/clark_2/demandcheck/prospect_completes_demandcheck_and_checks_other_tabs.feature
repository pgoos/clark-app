@javascript
Feature: Prospect customer completes demand check and then checks other tabs
  As a prospect customer
  I want to complete demand check and then check status of other tabs

  Scenario Outline: Prospect customer completes demand check and check status of other tabs
