...
RSpec.describe ComfortableMexicanSofa::Content::Tag::File do
  ...
  context "as: link" do
    ...
    it "returns valid tag" do
      expect(subject).to eq("<a href='https://test_dsf34r.cloudfront.net/#{blob.key}' target='_blank'></a>")
    end
  end
  ...
  context "as: image" do
    ...
    it "returns valid tag" do
      expect(subject).to eq("<img src='https://test_dsf34r.cloudfront.net/#{blob.key}' alt=''/>")
    end
  end
end
