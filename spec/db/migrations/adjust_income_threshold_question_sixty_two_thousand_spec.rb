...
require_migration "adjust_income_threshold_question_sixty_two_thousand"

describe AdjustIncomeThresholdQuestionSixtyTwoThousand, :integration do
  describe "#data" do
    ...
    let(:option1) do
      {
        label: "und verdiene bis zu 62.550€ Brutto jährlich",
        value: "bis 62.550"
      }
    end
    let(:option2) do
      {
        label: "und verdiene über 62.550€ Brutto jährlich",
        value: "uber 62.550"
      }
    end
