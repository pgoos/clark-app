...
require "composites/salesforce/repositories/events/payloads/appointment_confirmed_repository"

RSpec.describe Salesforce::Repositories::Events::Payloads::AppointmentConfirmedRepository do
  ...
  let!(:business_event) { create(:business_event, entity: appointment, action: "accept") }

  describe "#wrap" do
    it "returns appointment accepted event" do
      ...
      expect(event).to be_kind_of Salesforce::Entities::Events::AppointmentConfirmed
    end
