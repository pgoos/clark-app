...
require "composites/salesforce/repositories/events/payloads/opportunity_initiated_repository"

RSpec.describe Salesforce::Repositories::Events::Payloads::OpportunityInitiatedRepository do
  ...
  describe "#wrap" do
    it "returns opportunity initiated event" do
      ...
      expect(event).to be_kind_of Salesforce::Entities::Events::OpportunityInitiated
    end
