...
require "composites/salesforce/repositories/events/payloads/customer_accepted_repository"

RSpec.describe Salesforce::Repositories::Events::Payloads::CustomerAcceptedRepository do
  ...
  describe "#wrap" do
    it "returns customer accepted event" do
      ...
      expect(event).to be_kind_of Salesforce::Entities::Events::CustomerAccepted
    end
