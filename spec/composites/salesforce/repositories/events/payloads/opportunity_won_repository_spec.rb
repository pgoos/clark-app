...
require "composites/salesforce/repositories/events/payloads/opportunity_won_repository"

RSpec.describe Salesforce::Repositories::Events::Payloads::OpportunityWonRepository do
  ...
  describe "#wrap" do
    it "returns opportunity won event" do
      ...
      expect(event).to be_kind_of Salesforce::Entities::Events::OpportunityWon
    end
