...
require "composites/salesforce/repositories/events/payloads/product_updated_repository"

RSpec.describe Salesforce::Repositories::Events::Payloads::ProductUpdatedRepository do
  ...
  describe "#wrap" do
    it "returns product updated event" do
